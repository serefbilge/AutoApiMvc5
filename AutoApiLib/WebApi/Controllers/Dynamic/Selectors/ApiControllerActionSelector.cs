...
namespace AutoApiLib.WebApi.Controllers.Dynamic.Selectors
{
    ...
    /// </summary>
    public class ApiControllerActionSelector : System.Web.Http.Controllers.ApiControllerActionSelector
    {
        ...
        public override HttpActionDescriptor SelectAction(HttpControllerContext controllerContext)
        {
            ...
            if (!controllerContext.ControllerDescriptor.Properties.TryGetValue("__DynamicApiControllerInfo", out controllerInfoObj))
            {
            ...
            {
                throw new Exception("__DynamicApiControllerInfo in ControllerDescriptor.Properties is not a " + typeof(DynamicApiControllerInfo).FullName + " class.");
            }

            //No action name case
            var hasActionName = (bool)controllerContext.ControllerDescriptor.Properties["__DynamicApiHasActionName"];
            if (!hasActionName)
            {
