...
namespace AutoApiLib.WebApi.Controllers.ApiExplorer
{
    public class MyApiExplorer : System.Web.Http.Description.ApiExplorer, IApiExplorer, ISingletonDependency
    {
        private readonly Lazy<Collection<ApiDescription>> _apiDescriptions;
        private readonly IWebApiConfiguration _abpWebApiConfiguration;
