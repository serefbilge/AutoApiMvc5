...
using AutoApiLib.WebApi.Controllers.Dynamic.Interceptors;
using Application;
...
namespace AutoApiLib.WebApi.Controllers.Dynamic.Builders
{
    ...
    internal class ApiControllerBuilder<T> : IApiControllerBuilder<T>
    {
        ...
        public IApiControllerActionBuilder<T> ForMethod(string methodName)
        {
            ...
            {
                throw new Exception("There is no method with name " + methodName + " in type " + typeof(T).Name);
            }
        ...
        public void Build()
        {
            var controllerInfo = new DynamicApiControllerInfo(
                ...
                typeof(DynamicApiControllerInterceptor<T>),
                Filters,
