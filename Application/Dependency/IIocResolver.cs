...
namespace Application.Dependency
{
    ...
    public interface IIocResolver
    {
        ...
        /// <returns>The object instance</returns>
        T Resolve<T>(Arguments argumentsAsAnonymousType);
        ...
        /// <param name="argumentsAsAnonymousType">Constructor arguments</param>
        /// <returns>The object instance</returns>
        object Resolve(Type type, Arguments argumentsAsAnonymousType);
        ...
        /// <param name="argumentsAsAnonymousType">Constructor arguments</param>
        /// <returns>Object instances</returns>
        T[] ResolveAll<T>(Arguments argumentsAsAnonymousType);
        ...
        /// <param name="argumentsAsAnonymousType">Constructor arguments</param>
        /// <returns>Object instances</returns>
        object[] ResolveAll(Type type, Arguments argumentsAsAnonymousType);
